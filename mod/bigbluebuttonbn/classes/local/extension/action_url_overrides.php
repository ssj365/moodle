 ...
 */
class action_url_overrides {
    /**
     * Mutate the action URL.
     *
     * By design:
     *  1. we should use this class to override core plugin parameters.
     *  2. we cannot count on the order the subplugins are called
     *
     * @param string $action
     * @param array $data
     * @param array $metadata
     * @return array associative array with the data and metadata (indexed by 'data' and
     * 'metadata' keys).
     */
