...
Feature: The recording can be managed through the room page and as a user I can interact with the table
  ...
  Scenario: Recording should be sortable by date
    ...
    When I click on "div.sortable-header[data-sort='date'] span.sort-icon" "css_element"
    ...
    And I click on "div.sortable-header[data-sort='date'] span.sort-icon" "css_element"
